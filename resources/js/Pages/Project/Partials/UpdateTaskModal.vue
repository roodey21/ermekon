...
const openModal = (taskId) => {
    const taskData = props.project.data.tasks.find((t) => t.id === taskId)
    task.value = taskData
    form.name = taskData.name
    form.description = taskData.description
    form.package_id = taskData.package.id
    form.products = taskData.products
...
const deleteTaskItem = (index) => {
    form.products = form.products.filter((item, i) => i !== index)
