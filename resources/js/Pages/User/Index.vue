...
import { FunnelIcon, MagnifyingGlassIcon, PencilIcon, PlusIcon, TrashIcon } from '@heroicons/vue/24/outline'
import CreateUserModal from './Partials/CreateUserModal.vue';
import UpdateUserModal from './Partials/UpdateUserModal.vue';
import { ref } from 'vue'
...
<template>
                                ...
                                <tr v-for="user in users.data" :key="user.id" class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-2">
                                        <div class="flex gap-1">
                                            <Link :href="route('user.index', user.id)" type="button" class="p-1 text-white rounded bg-amber-500 hover:bg-amber-600 grow-none">
                                                <PencilIcon class="w-3 h-3"/>
                                            </Link>
                                            <button class="p-1 text-white bg-red-500 rounded hover:bg-red-600 grow-none" @click="deleteUser">
    ...
    <UpdateUserModal ref="updateModal" :user="props.user?.data"/>
</template>
