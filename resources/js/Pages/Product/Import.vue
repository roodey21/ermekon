                        ...
                        <div class="bg-white border">
                            ...
                            <div class="px-8 py-6">
                                <div class="mb-4 md:mb-6">
                                    <!-- note -->
                                    <span class="text-sm text-stone-700 font-medium">Contoh struktur tabel untuk import produk</span> <span class="text-sm text-stone-900 font-semibold">*(untuk sementara) :</span>
                                    <div class="relative overflow-x-auto">
                                        <table class="w-full text-sm text-left text-stone-500">
                                            <thead class="text-stone-100 uppercase bg-stone-800">
                                                <tr>
                                ...
                                <div class="mb-4 md:mb-6">
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-stone-300 border-dashed rounded-lg cursor-pointer bg-stone-50 hover:bg-stone-100">
